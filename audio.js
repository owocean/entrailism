...
module.exports = function (music, foldername, callback, thresh) {
    sox({
    ...
    exec("audiowaveform -i " + music + " -o output/" + foldername + "/track.json -b 8 -z 256", (error, stdout, stderr) => {
        construct(music,foldername,callback, thresh);
    });
}

function construct(music, foldername, callback, thresh) {
    let tmp = {};
